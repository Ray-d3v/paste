...
#define MyPublishDir "..\\..\\artifacts\\local-gpui"
...
OutputDir=output
OutputBaseFilename=PasteWinUI-GPUI-Setup-{#MyAppVersion}
Compression=lzma2
...
Name: "autostart"; Description: "Start automatically when signing in"; GroupDescription: "Startup options"; Flags: unchecked
